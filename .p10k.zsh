...
#
# 粉系可愛風
typeset -g my_pink='#ff79c6'        # 柔粉色 (Dracula 粉)
typeset -g my_peach='#ffb86c'       # 桃子橘
typeset -g my_mint='#8aff80'        # 薄荷綠
typeset -g my_babyblue='#8be9fd'    # 淡藍色 (淺湖水藍)
typeset -g my_lilac='#bd93f9'       # 淺紫 (Dracula 紫)
typeset -g my_softyellow='#f1fa8c'  # 柔黃

# 進階補充（霓虹感）
typeset -g my_neonpink='#ff4fa3'
typeset -g my_neonblue='#4dd0e1'
typeset -g my_purplegray='#b48ead'
...
() {
  ...
  #typeset -g POWERLEVEL9K_LOAD_NORMAL_BACKGROUND=66
  # Load color when load is between 50% and 70%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=178
  # Load color when load is over 70%.
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_BACKGROUND=166
  # Custom icon.
...
###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=$my_pink
  ...
  # typeset -g P9K_IP_INTERFACE='en0'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=$my_mint
  #typeset -g POWERLEVEL9K_TIME_FOREGROUND=$my_mint
