# Generated by Powerlevel10k configuration wizard on 2021-10-10 at 10:20 CST.
...
() {
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=7
  typeset -g POWERLEVEL9K_IP_FOREGROUND=1
